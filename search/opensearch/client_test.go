...
func TestClient(t *testing.T) {
	...
	searchReq := &opensearch.SearchRequest{
		...
		Format: "fulljson",
		// 以下子句为可选，根据实际需求添加
		// Filter: &opensearch.FilterClause{
		// 	Field:    "status",
		// 	Operator: "=",
		// 	Value:    1,
		// 	Logic:    "AND",
		// },
		// Sort: &opensearch.SortClause{
		// 	Field: "price",
		// 	Order: "-",
		// },
		// Distinct: &opensearch.DistinctClause{
		// 	Key:   "user_id",
		// 	Count: 1,
		// 	Times: 1,
		// },
		// Aggregate: &opensearch.AggregateClause{
		// 	GroupKey: "category",
		// 	AggFun:   "count()",
		// },
	...
	suggestReq := &opensearch.SuggestRequest{
		Query: "1",
		Hit:   10,
	}
	...
	// 测试 Hint 方法（底纹，结构化请求）
	hintReq := &opensearch.HintRequest{
		Hit:      10,
		SortType: "default",
	...
	hotSearchReq := &opensearch.HotSearchRequest{
		Hit:      10,
		SortType: "default",
		// UserID:    "user123",      // 可选：用户 ID
